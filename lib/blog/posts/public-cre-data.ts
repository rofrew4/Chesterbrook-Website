  ...
  sections: [
    {
      ...
      paragraphs: [
        "The dominant CRE data platforms, the ones whose names you know, built their value on the comp network. Properties that have transacted, properties currently marketed, properties listed by brokers in their system. That's the product. It works extremely well if you're underwriting on-market deals or comping a recent sale.",
        "It does not work for sourcing off-market. By definition, the deals worth chasing aren't in those databases yet. The owner hasn't engaged a broker. The property hasn't traded in a decade. The signals that something's about to move don't show up on a comp platform because they're not comps: a transfer into a trust, a long hold approaching the end of a hold period, a tax delinquency.",
    ...
    },
    {
      ...
      list: [
        ...
        "Data refresh is the maintenance burden. The signals you care about, like recent transfers and new lis pendens, only matter if they're current. A static one-time pull goes stale within a quarter. A real tool refreshes on a schedule and flags what changed.",
      ],
    },
    {
