  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "Chesterbrook is an AI consulting and software firm based in McLean, Virginia, serving commercial real estate, property management, and development clients. Its work spans deal sourcing engines, lease abstraction, custom CRMs, email agents, and internal tooling.",
        },
        {
          type: "p",
