  ...
  sections: [
    {
      ...
      list: [
        ...
        "The cost of custom has dropped by an order of magnitude. Not because development is cheap — it isn't — but because AI has compressed the parts of the build that used to take the longest. Document extraction, structured data parsing, classification, drafting, and search across unstructured documents all used to require months of engineering. They're now days of engineering. The economics flipped fast, and they kept flipping.",
      ],
    },
    {
      paragraphs: [
